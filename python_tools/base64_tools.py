...
def encode_str(str):
    ...
    encode_str = base64.b64encode(str.encode('utf-8'))
...
original_str = "ms08067"
print(encode_str(original_str))

base_str = encode_str(original_str)
print(decode_str(str(base_str,'utf-8')))